...
def plot_graphs(provider_wise_res_bmm, provider_wise_res_mm, providers, matrix_configurations, bmm=True, mm=True):
...
def run_all_matrix_configs(matrix_configurations, providers, activations):
    ...
    for matrix_configuration in matrix_configurations:
        ...
        for provider in providers:
            for activation in activations:
                ...
                if (ans_bmm == None or ans_mm == None):
                    continue
    ...
    plot_graphs(provider_wise_res_bmm, provider_wise_res_mm, providers, matrix_configurations, bmm=True, mm=False)
...
if __name__ == "__main__":
    ...
    run_all_matrix_configs(matrix_configurations, providers, activations)
